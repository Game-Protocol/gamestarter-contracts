...
contract BancorConverterUpgrader is Ownable {
    ...
    /**
        @dev constructor
    */
    constructor(IBancorConverterFactory _bancorConverterFactory)
        public
    {
    ...
    */
    ...
    /**
        ...
        @param _newConverter    new converter contract address
    */
    function copyConversionFee(IBancorConverter _oldConverter, IBancorConverter _newConverter) private view {
    ...
    /**
        ...
        @param _newConverter    new converter contract address
    */
    function copyQuickBuyPath(IBancorConverter _oldConverter, IBancorConverter _newConverter) private view {
